...
const Hero = () => {
  return (
    <section className="text-text px-4 py-16 md:py-24">
      <div className="max-w-md mx-auto text-center animate-fade-in">
        {/* <div>

        </div> */}
        <h1 className="font-headline text-3xl md:text-4xl font-semibold leading-tight">
            Anbu Gynaecare
        </h1>
        <p className="font-headline font-semibold text-md md:text-xl leading-relaxed mb-4">
          Period care that loves you back.
        </p>
        <Image className="mx-auto mb-6"
          src="/anbu logo svg.svg" alt="Anbu Gynaecare Logo"
          width={150}
          height={120}
        />
        ...
        <div className="flex flex-col sm:flex-row w-fit mx-auto gap-4 justify-center">
